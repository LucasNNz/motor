import { browserRuntime, DEFAULT_MODEL, TRANSFORMERS_VERSION } from './browser_runtime.js?v=0.12.12';
...
// V0.12.12 · exportação de operação no navegador · produção guiada
