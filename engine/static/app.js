import { browserRuntime, DEFAULT_MODEL, TRANSFORMERS_VERSION } from './browser_runtime.js?v=0.12.14';
...
// V0.12.14 · validação semântica e transparência real · produção guiada
